function varargout = aib(varargin)
% VL_AIB  Agglomerative Information Bottleneck
%   PARENTS = VL_AIB(PCX) runs Agglomerative Information Bottleneck (AIB)
...
%   the tree the state of the VL_AIB algorithm at each step (see VL_AIBCUT())
...
[varargout{1:nargout}] = vl_aib(varargin{:});
